...
const Register = () => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white dark:bg-[#23312B] p-8 rounded-xl shadow-md dark:shadow-black/40 mt-12">
      <h1 className="text-2xl font-bold text-center mb-6 text-tea-dark dark:text-tea-light">Регистрация</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className="w-full bg-tea-dark hover:bg-tea-green text-white font-bold py-2 px-4 rounded transition">
          Зарегистрироваться
        </button>
      </form>
      <p className="mt-4 text-center text-sm">
        Уже есть аккаунт? <Link to="/login" className="text-tea-gold font-bold hover:underline">Войти</Link>
      </p>
    </div>
  );
};
